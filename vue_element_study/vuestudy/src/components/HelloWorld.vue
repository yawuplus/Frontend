  ...
  <div class="hello">
    ...
    <div class="form-binding">
      ...
      <div>
        ...
        <p>自动转换输入类型为number:</p>
        请输入年龄:&nbsp;&nbsp;<input v-model.number="age"
               type="number">
        <p>{{age}}</p>
        <p>过滤输入的收尾空白字符</p>
...
export default {
  ...
  data ()
  {
    return {
      ...
      posts: [
        { id: 1, content: "this is first con", title: 'My journey with Vue', 'post_time': new Date(), postFontSize: 1, },
        { id: 2, content: "this is second con", title: 'Blogging with Vue', 'post_time': new Date(), postFontSize: 2, },
        { id: 3, content: "this is third con", title: 'Why Vue is so fun', 'post_time': new Date(), postFontSize: 3 }
      ],
      postFontSize: 1,
    };
  },
...
Vue.component( 'single-data-flow', {
  ...
  inherAttrs: false,
  template: '<button v-on:click="counter += 1">You have clicked {{ counter }} times .</button>',
  data: function ()
  {
    return {
      counter: 0,
